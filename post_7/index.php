    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tambah-data').click(function() {
                // Pastikan pengguna sudah login sebelum menampilkan form tambah data
            ...
            // Menangani tampilan form login
            $('#login-form').show();
            $('.close').click(function() {
                $('#login-form').hide();
            });

            // Menangani tampilan form register
            $('#register-form').show();
            $('.close').click(function() {
                $('#register-form').hide();
            });
            ...
            $('#login-form-fields').submit(function(event) {
                event.preventDefault();
                var username = $('#login-username').val();
                var password = $('#login-password').val();
                // Lakukan validasi login di sini dengan mengirimkan data ke server
            });

            // Tangani submit form register
            $('#register-form-fields').submit(function(event) {
                event.preventDefault();
                var username = $('#register-username').val();
                var email = $('#register-email').val();
                var password = $('#register-password').val();
                // Lakukan validasi register di sini dengan mengirimkan data ke server
            });
        });
    </script>
...
<body>
    ...
    <body>
     ...
     <!-- Tabel dan konten lainnya di sini -->
     <a href="logout.php">Logout</a> <!-- Tambahkan link untuk logout -->
